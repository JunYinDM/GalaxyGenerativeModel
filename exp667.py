...
writer = SummaryWriter("run917/919_exp667",)  ################################################### change name 
...
for epoch in range(num_epochs):
    ...
    if epoch % 10 == 0:
        ...
        torch.save(x, './gal_img919/exp667_x_{}.pt'.format(epoch))
        torch.save(x_hat, './gal_img919/exp667_x_hat_{}.pt'.format(epoch))
        torch.save(test_x, './gal_img919/exp667_test_x_{}.pt'.format(epoch))
        torch.save(test_x_hat, './gal_img919/exp667_test_x_hat_{}.pt'.format(epoch))       
