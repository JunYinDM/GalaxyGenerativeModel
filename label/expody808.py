...
writer = SummaryWriter("run1001/expody808",)  ################################################### change name 
...
for epoch in range(num_epochs):
    ...
    if epoch % 10 == 0:
        ...
        torch.save(x, './gal_img1001/expody808_x_{}.pt'.format(epoch))
        torch.save(x_hat, './gal_img1001/expody808_x_hat_{}.pt'.format(epoch))
        torch.save(test_x, './gal_img1001/expody808_test_x_{}.pt'.format(epoch))
        torch.save(test_x_hat, './gal_img1001/expody808_test_x_hat_{}.pt'.format(epoch))
        torch.save(model.state_dict(), './gal_img1001/expody808_{}.pth'.format(epoch))     