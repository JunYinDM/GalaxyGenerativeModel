...
writer = SummaryWriter("run1001/exp482",)  ################################################### change name 
...
model.load_state_dict(torch.load('gal_img1001/exp479_4440.pth'))    ###
...
for epoch in range(num_epochs):
    ...
    if epoch % 10 == 0:
        ...
        torch.save(x, './gal_img1001/exp482_x_{}.pt'.format(epoch))
        torch.save(x_hat, './gal_img1001/exp482_x_hat_{}.pt'.format(epoch))
        torch.save(test_x, './gal_img1001/exp482_test_x_{}.pt'.format(epoch))
        torch.save(test_x_hat, './gal_img1001/exp482_test_x_hat_{}.pt'.format(epoch))
        torch.save(model.state_dict(), './gal_img1001/exp482_{}.pth'.format(epoch))     